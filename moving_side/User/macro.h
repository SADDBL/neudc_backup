...
#define SCREEN_K 0.45f
extern pid pid_stp1,pid_stp2;	//2：红色激光笔x轴，1：红色激光笔y轴
...
#define RECTANGULAR_DETECT HAL_UART_Transmit(&huart1,(uint8_t*)"a",1,10);
#define LASER_DETECT HAL_UART_Transmit(&huart1,(uint8_t*)"b",1,10);
